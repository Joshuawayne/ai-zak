let userId = localStorage.getItem('userId'); // Global declaration
...
function login() {
    ...
    userId = username; // Assign to global userId
    localStorage.setItem('userId', userId);
    console.log('userId set to:', userId); // Debug
    document.getElementById('login-container').style.display = 'none';
    typePreloader(() => {
        console.log('Calling loadChat with userId:', userId); // Debug
